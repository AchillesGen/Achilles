...
option(ACHILLES_USE_FAST_LINKER "Use mold/lld instead of the default linker if available" ON)
if(ACHILLES_USE_FAST_LINKER AND NOT MSVC AND NOT CMAKE_VERSION VERSION_LESS 3.18)
    include(CheckLinkerFlag)
    foreach(_ld mold lld)
        check_linker_flag(CXX "-fuse-ld=${_ld}" ACHILLES_HAVE_LD_${_ld})
        if(ACHILLES_HAVE_LD_${_ld})
            add_link_options("-fuse-ld=${_ld}")
            message(STATUS "Using ${_ld} linker")
            break()
        endif()
    endforeach()
endif()
