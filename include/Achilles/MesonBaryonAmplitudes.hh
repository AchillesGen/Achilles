...
//TODO move some to private 
	...
	std::string PWnames[nPW] = {"S11","S31","P11","P13","P31","P33","D13",
     		"D15","D33","D35","F15","F17",
     		"F35","F37","G17","G19","G37","G39","H19","H39"};
	...
	double CGcof[maxMBchan][2][5][5] = {0.}; // (I_3^{m}, I_3^{b}; Im, Ib | I , I_3) = CGcof[ichan][I-1/2][2I_3^m + 2][2I_3^b + 2] 
	...
	double H_poly[Lmax+1][Lmax+1][2*Lmax+1] = {0.}; //H = P_n(x) * P_m(x)  = \sum a_k x^k, the coefficients a_k are H_poly[n][m]  saved
