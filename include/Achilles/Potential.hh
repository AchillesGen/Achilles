...
class Potential {
    ...
    protected:
        PotentialVals stencil5(std::function<achilles::PotentialVals(double)> f, double x, double h) const;
        PotentialVals stencil5second(std::function<achilles::PotentialVals(double)> f, double x, double h) const;
