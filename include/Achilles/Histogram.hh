...
class Histogram {
  public:
    Histogram() = default;
    Histogram(const size_t &, const double &, const double &, std::string, std::string path = "");
...
class YODAHistogram : public Histogram {
  public:
    YODAHistogram(const size_t &, const double &, const double &, const std::string &,
...
class ROOTHistogram : public Histogram {
  public:
    ROOTHistogram(const size_t &, const double &, const double &, const std::string &,
                  const std::string &path = "");
...
#if HAVE_ROOT
    ~HistogramCollection() { delete f; }
#endif

    void InitializeHists();

    bool AddHistogram(const size_t &, const double &, const double &, const std::string &,
                      const std::string &path = "");
    bool AddHistogram(const std::vector<double> &, const std::string &,
                      const std::string &path = "");
