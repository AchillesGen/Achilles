...
class HardScatteringFactory {
  public:
    ...
    static std::unique_ptr<HardScattering> Create(const std::string &, const YAML::Node &, RunMode);
...
#define REGISTER_HARDSCATTERING(hardscattering)                                  \
    bool hardscattering::registered = achilles::HardScatteringFactory::Register( \
        hardscattering::GetName(), hardscattering::Create)
