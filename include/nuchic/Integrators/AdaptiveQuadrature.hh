...
class AdaptiveQuadrature : AdaptiveIntegrator {
    public:
        AdaptiveQuadrature(std::unique_ptr<QuadratureIntegrator>,
                           const size_t&, bool cache=true);
        AdaptiveQuadrature(std::unique_ptr<QuadratureIntegrator>, const size_t&,
                           const FunctionS&, bool cache=true);
        AdaptiveQuadrature(std::unique_ptr<QuadratureIntegrator>, const size_t&,
                           const FunctionV&, bool cache=true);
