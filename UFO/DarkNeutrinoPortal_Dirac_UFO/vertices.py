...
#                particles = [ P.d__tilde__, P.d, P.Z_D ],
#                color = [ 'Identity(1,2)' ],
#                lorentz = [ L.FFV1 ],
#                couplings = {(0,0):C.GC_10})
# 
# V_102 = Vertex(name = 'V_102',
#                particles = [ P.s__tilde__, P.s, P.Z_D ],
#                color = [ 'Identity(1,2)' ],
#                lorentz = [ L.FFV1 ],
#                couplings = {(0,0):C.GC_10})
# 
# V_103 = Vertex(name = 'V_103',
#                particles = [ P.b__tilde__, P.b, P.Z_D ],
#                color = [ 'Identity(1,2)' ],
#                lorentz = [ L.FFV1 ],
#                couplings = {(0,0):C.GC_10})

V_104 = Vertex(name = 'V_104',
               particles = [ P.e__plus__, P.e__minus__, P.Z_D ],
               color = [ '1' ],
               lorentz = [ L.FFV1 ],
               couplings = {(0,0):C.GC_12})

V_105 = Vertex(name = 'V_105',
               particles = [ P.mu__plus__, P.mu__minus__, P.Z_D ],
               color = [ '1' ],
               lorentz = [ L.FFV1 ],
               couplings = {(0,0):C.GC_12})

V_106 = Vertex(name = 'V_106',
               particles = [ P.ta__plus__, P.ta__minus__, P.Z_D ],
               color = [ '1' ],
               lorentz = [ L.FFV1 ],
               couplings = {(0,0):C.GC_12})

# V_107 = Vertex(name = 'V_107',
#                particles = [ P.u__tilde__, P.u, P.Z_D ],
#                color = [ 'Identity(1,2)' ],
#                lorentz = [ L.FFV1 ],
#                couplings = {(0,0):C.GC_11})
# 
# V_108 = Vertex(name = 'V_108',
#                particles = [ P.c__tilde__, P.c, P.Z_D ],
#                color = [ 'Identity(1,2)' ],
#                lorentz = [ L.FFV1 ],
#                couplings = {(0,0):C.GC_11})
# 
# V_109 = Vertex(name = 'V_109',
#                particles = [ P.t__tilde__, P.t, P.Z_D ],
#                color = [ 'Identity(1,2)' ],
#                lorentz = [ L.FFV1 ],
#                couplings = {(0,0):C.GC_11})

V_110 = Vertex(name = 'V_110',
               particles = [ P.vm__tilde__, P.v_D, P.Z_D ],
               color = [ '1' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_31})

V_111 = Vertex(name = 'V_111',
               particles = [ P.v_D__tilde__, P.vm, P.Z_D ],
               color = [ '1' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_31})
