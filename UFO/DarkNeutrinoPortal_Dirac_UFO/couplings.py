...
GC_10 = Coupling(name = 'GC_10',
                 value = '-(eeps*complex(0,1))/3.',
                 order = {'NP':1})

GC_11 = Coupling(name = 'GC_11',
                 value = '(2*eeps*complex(0,1))/3.',
                 order = {'NP':1})

GC_12 = Coupling(name = 'GC_12',
                 value = '-(eeps*complex(0,1))',
                 order = {'NP':1})
...
GC_99 = Coupling(name = 'GC_99',
                 value = '(ee*complex(0,1))/(sw*cmath.sqrt(2)*2)',
                 order = {'QED':1})
...
GC_102 = Coupling(name = 'GC_102',
                  value = '(6*ee*complex(0,1))',
                  order = {'QED':1})

GC_103 = Coupling(name = 'GC_103',
                  value = '6*eeps*complex(0,1)',
                  order = {'NP':1})

GC_104 = Coupling(name = 'GC_104',
                  value = '(18*ee*complex(0,1))',
                  order = {'QED':1})
