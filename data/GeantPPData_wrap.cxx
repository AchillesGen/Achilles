...
#define SWIGTYPE_p_G4LEpp swig_types[0]
...
/*-----------------------------------------------
              @(target):= _GeantPPData.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__GeantPPData

#else
#  define SWIG_init    init_GeantPPData

#endif
#define SWIG_name    "_GeantPPData"
...
SWIGINTERN PyObject *_wrap_new_G4LEpp(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  G4LEpp *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)":new_G4LEpp")) SWIG_fail;
  result = (G4LEpp *)new G4LEpp();
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_G4LEpp, SWIG_POINTER_NEW |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_delete_G4LEpp(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  G4LEpp *arg1 = (G4LEpp *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject * obj0 = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:delete_G4LEpp",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_G4LEpp, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_G4LEpp" "', argument " "1"" of type '" "G4LEpp *""'"); 
  }
  arg1 = reinterpret_cast< G4LEpp * >(argp1);
  delete arg1;
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
...
SWIGINTERN PyObject *G4LEpp_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!PyArg_ParseTuple(args,(char *)"O:swigregister", &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_G4LEpp, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"new_G4LEpp", _wrap_new_G4LEpp, METH_VARARGS, NULL},
	 { (char *)"delete_G4LEpp", _wrap_delete_G4LEpp, METH_VARARGS, NULL},
	 { (char *)"G4LEpp_swigregister", G4LEpp_swigregister, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
...
static swig_type_info _swigt__p_G4LEpp = {"_p_G4LEpp", "G4LEpp *", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_G4LEpp[] = {  {&_swigt__p_G4LEpp, 0, 0, 0},{0, 0, 0, 0}};
