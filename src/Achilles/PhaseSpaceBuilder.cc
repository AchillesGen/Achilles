...
PSBuilder &PSBuilder::Beam(std::shared_ptr<achilles::Beam> beam, const std::vector<double> &masses,
                           size_t idx) {
...
PSBuilder &PSBuilder::Hadron(const std::string &mode, const std::vector<double> &masses,
                             size_t idx) {
