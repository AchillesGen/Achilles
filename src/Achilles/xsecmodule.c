...
/* See f2py2e/rules.py */
extern void F_FUNC(cc1,CC1)(double*,double*,double*,double*,double*,double*,double*,double*,int*,double*);
...
/* extern void F_FUNC(cc1,CC1)(double*,double*,double*,double*,double*,double*,double*,double*,int*,double*); */
static PyObject *f2py_rout_xsec_cc1(const PyObject *capi_self,
                           PyObject *capi_args,
...
f2py_start_clock();
  ...
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOOOOOOOO:xsec.cc1",\
    capi_kwlist,&xq_capi,&w_capi,&wt_capi,&xk_capi,&xp_capi,&phi_capi,&ee0_capi,&theta_capi,&ig_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable xq */
    f2py_success = double_from_pyobj(&xq,xq_capi,"xsec.cc1() 1st argument (xq) can't be converted to double");
  if (f2py_success) {
  /* Processing variable w */
    f2py_success = double_from_pyobj(&w,w_capi,"xsec.cc1() 2nd argument (w) can't be converted to double");
  if (f2py_success) {
  /* Processing variable wt */
    f2py_success = double_from_pyobj(&wt,wt_capi,"xsec.cc1() 3rd argument (wt) can't be converted to double");
  if (f2py_success) {
  /* Processing variable xk */
    f2py_success = double_from_pyobj(&xk,xk_capi,"xsec.cc1() 4th argument (xk) can't be converted to double");
  if (f2py_success) {
  /* Processing variable xp */
    f2py_success = double_from_pyobj(&xp,xp_capi,"xsec.cc1() 5th argument (xp) can't be converted to double");
  if (f2py_success) {
  /* Processing variable phi */
    f2py_success = double_from_pyobj(&phi,phi_capi,"xsec.cc1() 6th argument (phi) can't be converted to double");
  if (f2py_success) {
  /* Processing variable ee0 */
    f2py_success = double_from_pyobj(&ee0,ee0_capi,"xsec.cc1() 7th argument (ee0) can't be converted to double");
  if (f2py_success) {
  /* Processing variable theta */
    f2py_success = double_from_pyobj(&theta,theta_capi,"xsec.cc1() 8th argument (theta) can't be converted to double");
  if (f2py_success) {
  /* Processing variable ig */
    f2py_success = int_from_pyobj(&ig,ig_capi,"xsec.cc1() 9th argument (ig) can't be converted to int");
  if (f2py_success) {
  ...
  if (capi_sig_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(xsec_error,"failed in converting hidden `sig' of xsec.cc1 to C/Fortran array" );
  } else {
...
#endif
/*callfortranroutine*/
        (*f2py_func)(&xq,&w,&wt,&xk,&xp,&phi,&ee0,&theta,&ig,sig);
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
...
"sig : float";
/* extern void F_FUNC(sigccc,SIGCCC)(double*,int*); */
static PyObject *f2py_rout_xsec_sigccc(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
...
/*frompyobj*/
  /* Processing variable sig */
  /* Processing variable ig */
    f2py_success = int_from_pyobj(&ig,ig_capi,"xsec.sigccc() 1st argument (ig) can't be converted to int");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "O:xsec.dirac_matrices.dirac_matrices_in",\
    capi_kwlist,&xmn_in_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable xmn_in */
    f2py_success = double_from_pyobj(&xmn_in,xmn_in_capi,"xsec.dirac_matrices.dirac_matrices_in() 1st argument (xmn_in) can't be converted to double");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    ":xsec.dirac_matrices.define_spinors",\
    capi_kwlist))
    return NULL;
/*frompyobj*/
/*end of frompyobj*/
...
/*  */
static PyObject *f2py_rout_xsec_dirac_matrices_current_init(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOO:xsec.dirac_matrices.current_init",\
...
/*frompyobj*/
  ...
  capi_p1_in_tmp = array_from_pyobj(NPY_DOUBLE,p1_in_Dims,p1_in_Rank,capi_p1_in_intent,p1_in_capi);
  if (capi_p1_in_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(xsec_error,"failed in converting 1st argument `p1_in' of xsec.dirac_matrices.current_init to C/Fortran array" );
  } else {
  ...
  capi_pp1_in_tmp = array_from_pyobj(NPY_DOUBLE,pp1_in_Dims,pp1_in_Rank,capi_pp1_in_intent,pp1_in_capi);
  if (capi_pp1_in_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(xsec_error,"failed in converting 2nd argument `pp1_in' of xsec.dirac_matrices.current_init to C/Fortran array" );
  } else {
  ...
  capi_q_in_tmp = array_from_pyobj(NPY_DOUBLE,q_in_Dims,q_in_Rank,capi_q_in_intent,q_in_capi);
  if (capi_q_in_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(xsec_error,"failed in converting 3rd argument `q_in' of xsec.dirac_matrices.current_init to C/Fortran array" );
  } else {
...
/*cleanupfrompyobj*/
  if((PyObject *)capi_q_in_tmp!=q_in_capi) {
    Py_XDECREF(capi_q_in_tmp); }
  }  /*if (capi_q_in_tmp == NULL) ... else of q_in*/
  /* End of cleaning variable q_in */
  if((PyObject *)capi_pp1_in_tmp!=pp1_in_capi) {
    Py_XDECREF(capi_pp1_in_tmp); }
  }  /*if (capi_pp1_in_tmp == NULL) ... else of pp1_in*/
  /* End of cleaning variable pp1_in */
  if((PyObject *)capi_p1_in_tmp!=p1_in_capi) {
    Py_XDECREF(capi_p1_in_tmp); }
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OO:xsec.dirac_matrices.det_ja",\
    capi_kwlist,&f1v_capi,&f2v_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable f1v */
    f2py_success = double_from_pyobj(&f1v,f1v_capi,"xsec.dirac_matrices.det_ja() 1st argument (f1v) can't be converted to double");
  if (f2py_success) {
  /* Processing variable f2v */
    f2py_success = double_from_pyobj(&f2v,f2v_capi,"xsec.dirac_matrices.det_ja() 2nd argument (f2v) can't be converted to double");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OO:xsec.dirac_matrices.det_res1b",\
    capi_kwlist,&rl_capi,&rt_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable rl */
    f2py_success = double_from_pyobj(&rl,rl_capi,"xsec.dirac_matrices.det_res1b() 1st argument (rl) can't be converted to double");
  if (f2py_success) {
  /* Processing variable rt */
    f2py_success = double_from_pyobj(&rt,rt_capi,"xsec.dirac_matrices.det_res1b() 2nd argument (rt) can't be converted to double");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
...
static FortranDataDef f2py_xsec_def[] = {
  ...
  {"pf2",0,{{-1}},NPY_DOUBLE},
  {"sint",0,{{-1}},NPY_DOUBLE},
  {"sina2",0,{{-1}},NPY_DOUBLE},
  {"wf",0,{{-1}},NPY_DOUBLE},
  {"wtf",0,{{-1}},NPY_DOUBLE},
  {NULL}
};

static void f2py_setup_xsec(char *xmp,char *xmn,char *xm,char *hbarc,char *g_f,char *pi,char *c0,char *e,char *ef,char *cost,char *q2,char *p2,char *pf2,char *sint,char *sina2,char *wf,char *wtf) {
  int i_f2py=0;
...
extern void F_FUNC(f2pyinitxsec,F2PYINITXSEC)(void (*)(char*,char*,char*,char*,char*,char*,char*,char*,char*,char*,char*,char*,char*,char*,char*,char*,char*));
...
static FortranDataDef f2py_dirac_matrices_def[] = {
  {"dirac_matrices_in",-1,{{-1}},0,NULL,(void *)f2py_rout_xsec_dirac_matrices_dirac_matrices_in,doc_f2py_rout_xsec_dirac_matrices_dirac_matrices_in},
  {"define_spinors",-1,{{-1}},0,NULL,(void *)f2py_rout_xsec_dirac_matrices_define_spinors,doc_f2py_rout_xsec_dirac_matrices_define_spinors},
  {"current_init",-1,{{-1}},0,NULL,(void *)f2py_rout_xsec_dirac_matrices_current_init,doc_f2py_rout_xsec_dirac_matrices_current_init},
  {"det_ja",-1,{{-1}},0,NULL,(void *)f2py_rout_xsec_dirac_matrices_det_ja,doc_f2py_rout_xsec_dirac_matrices_det_ja},
  {"det_res1b",-1,{{-1}},0,NULL,(void *)f2py_rout_xsec_dirac_matrices_det_res1b,doc_f2py_rout_xsec_dirac_matrices_det_res1b},
  {NULL}
};

static void f2py_setup_dirac_matrices(char *dirac_matrices_in,char *define_spinors,char *current_init,char *det_ja,char *det_res1b) {
  int i_f2py=0;
...
extern void F_FUNC_US(f2pyinitdirac_matrices,F2PYINITDIRAC_MATRICES)(void (*)(char *,char *,char *,char *,char *));
...
static FortranDataDef f2py_routine_defs[] = {
  {"cc1",-1,{{-1}},0,(char *)F_FUNC(cc1,CC1),(f2py_init_func)f2py_rout_xsec_cc1,doc_f2py_rout_xsec_cc1},
  {"sigccc",-1,{{-1}},0,(char *)F_FUNC(sigccc,SIGCCC),(f2py_init_func)f2py_rout_xsec_sigccc,doc_f2py_rout_xsec_sigccc},
...
PyMODINIT_FUNC initxsec(void) {
  ...
  import_array();
  if (PyErr_Occurred())
    {PyErr_SetString(PyExc_ImportError, "can't initialize module xsec (failed to import numpy)"); return RETVAL;}
...
"  sig = cc1(xq,w,wt,xk,xp,phi,ee0,theta,ig)\n"
"  sig = sigccc(ig)\n"
"Fortran 90/95 modules:\n""  xsec --- xmp,xmn,xm,hbarc,g_f,pi,c0,e,ef,cost,q2,p2,pf2,sint,sina2,wf,wtf""  dirac_matrices --- dirac_matrices_in(),define_spinors(),current_init(),det_ja(),det_res1b()"".");
...
/*eof initf2pywraphooks*/
  PyDict_SetItemString(d, "dirac_matrices", PyFortranObject_New(f2py_dirac_matrices_def,f2py_init_dirac_matrices));
...
#ifdef F2PY_REPORT_ATEXIT
  if (! PyErr_Occurred())
    on_exit(f2py_report_on_exit,(void*)"xsec");
#endif
