...
NewtonCotes::NewtonCotes(const size_t &order, bool closed) : QuadratureIntegrator(), m_order(order) {
...
void NewtonCotes::SetupClosed() {
    ...
    if(m_order == 2) {
        ...
        baseFunc = [&](const double &a, const double &h) -> double {
            return 3*h/8*(Function(a)+3*Function(a+h)+3*Function(a+2*h)+Function(a+3*h));
        };
        errFunc = [&](const double &a, const double &h) -> double {
            return h/3*(Function(a)+4*Function(a+h)+Function(a+2*h));
        };
        ...
        baseFunc = [&](const double &a, const double &h) -> double {
            return 2*h/45*(7*Function(a)+32*Function(a+h)+12*Function(a+2*h)
...
void NewtonCotes::SetupOpen() {
    ...
    if(m_order == 3) {
        ...
        baseFunc = [&](const double &a, const double &h) -> double {
            return 4*h/3*(2*Function(a+h)-Function(a+2*h)+2*Function(a+3*h));
        };
        errFunc = [&](const double &a, const double &h) -> double {
            return 3*h/2*(Function(a+h) + Function(a+2*h));
        };
        ...
        baseFunc = [&](const double &a, const double &h) -> double {
            return 5*h/24*(11*Function(a+h)+Function(a+2*h)+Function(a+3*h)+11*Function(a+4*h));
        };
        errFunc = [&](const double &a, const double &h) -> double {
            return 4*h/3*(2*Function(a+h)-Function(a+2*h)+2*Function(a+3*h));
        };
