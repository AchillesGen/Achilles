...
std::vector<double> AdaptiveQuadrature::IntegrateVec(const double&, const double&,
                                                     const double&, const double&) {
    throw std::runtime_error("Not implemented!");
}

double AdaptiveQuadrature::Integrate(const double &a, const double &b,
    ...
    spdlog::debug("Iteration 1 (lower, upper, value, error): {}, {}, {}, {}",
