...
+=================================================================+
    ...
    fmt::print(fmt::emphasis::bold | fg(fmt::terminal_color::red),
               "NOTE: You are running in cascade test mode. Hard interactions are not included\n");
}

static const std::string USAGE =
R"(
    Usage:
      nuchic-cascade [<input>] [-v | -vv]
      nuchic-cascade (-h | --help)
      nuchic-cascade --version
