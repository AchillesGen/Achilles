...
nuchic::MultiChannel::MultiChannel(size_t dims, size_t nchannels, MultiChannelParams params_) 
...
void nuchic::MultiChannel::MaxDifference(const std::vector<double> &train) {
    double max = 0;
...
nuchic::MultiChannelSummary nuchic::MultiChannel::Summary() {
...
void nuchic::MultiChannel::PrintIteration() const {
