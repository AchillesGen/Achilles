...
void C1_2::GeneratePoint(std::vector<Vec4D> &p, const std::vector<double> &ran) const {
...
double C1_2::GenerateWeight(const std::vector<Vec4D> &p, std::vector<double> &ran) const {
    double tmass201 = Flavour((kf_code)(23)).Mass();
