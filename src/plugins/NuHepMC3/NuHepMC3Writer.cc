...
using achilles::NuHepMC3Writer;

std::shared_ptr<std::ostream> NuHepMC3Writer::InitializeStream(const std::string &filename, bool zipped) {
...
void NuHepMC3Writer::Write(const achilles::Event &event) {
