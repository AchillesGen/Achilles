...
TEST_CASE("CM Momentum Delta solver", "[DeltaFunctions]") {
    ...
    double phi = 0;
    auto p3 =
        achilles::SolveDelta(p1, p2, achilles::Constant::mN, achilles::Constant::mN, cosTheta, phi);
    auto p4 = p1 + p2 - p3;
    ...
    SECTION("WiringaPotential") {
        ...
        while(true) {
            try {
                ...
                p3 = achilles::SolveDeltaWithPotential(q, potential, achilles::Constant::mN,
                                                       achilles::Constant::mN, p3Mag, phi, r1, r2);
                break;
