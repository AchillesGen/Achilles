...
TEST_CASE("Arbitrary Frame Delta solver", "[DeltaFunctions]") {
        ...
        auto p1 = GENERATE(take(10, randomMomentum(1000, nuchic::Constant::mN))); 
        auto p2 = GENERATE(take(10, randomMomentum(1000, nuchic::Constant::mN))); 
...
TEST_CASE("Potential Delta solver", "[DeltaFunctions]") {
    ...
    auto p1 = GENERATE(take(10, randomMomentum(1000, nuchic::Constant::mN))); 
    auto p2 = GENERATE(take(10, randomMomentum(225, nuchic::Constant::mN))); 
    ...
    SECTION("WiringaPotential") {
        ...
        nuchic::WiringaPotential potential(nucleus, rho0);
        ...
        double phi = 2*M_PI*m_dist(m_rand);
        auto range = nuchic::FindMomentumRange(q_free);
        ...
        while(true) {
            try {
                ...
                p3 = nuchic::SolveDeltaWithPotential(q, potential, nuchic::Constant::mN, nuchic::Constant::mN,
                                                     p3Mag, phi, r1, r2);
                break;
