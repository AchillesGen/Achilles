...
TEST_CASE("CrossSection", "[HardScattering]") {
    ...
    ATOOLS::s_kftable[kf_none] = new ATOOLS::Particle_Info(0,-1,0,0,0,0,-1,0,1,0,"no_particle","no_particle","no_particle", "no_particle", 1,1);
    ATOOLS::s_kftable[kf_e] = new ATOOLS::Particle_Info(11,0.000511,.0,-3,0,1,0,1,1,0,"e-","e+", "e^{-}", "e^{+}");
