...
TEST_CASE("EventHistory Visitor", "[EventHistory]") {
    ...
    SECTION("Expected output") {
        ...
        std::string expected2 = R"exp(Node(target, {Particle[1000060120, 0, FourVector(1.11880000e+04, 0.00000000e+00, 0.00000000e+00, 0.00000000e+00), ThreeVector(0, 0, 0)]} -> {Particle[2112, 0, FourVector(9.18006610e+02, 2.35858336e+01, 8.53323854e+01, 5.23789929e+01), ThreeVector(0, 0, 0)]}))exp";
        std::string expected3 = R"exp(Node(beam, {Particle[14, 0, FourVector(1.00000000e+04, 0.00000000e+00, 0.00000000e+00, 1.00000000e+04), ThreeVector(0, 0, 0)]} -> {Particle[14, 0, FourVector(5.39833437e+03, 0.00000000e+00, 0.00000000e+00, 5.39833437e+03), ThreeVector(0, 0, 0)]}))exp";
    ...
    SECTION("Mock Visitor") {
        ...
        MockVisitor visitor;
        REQUIRE_CALL(visitor, visit(history.Node(0)))
            .TIMES(1);
        REQUIRE_CALL(visitor, visit(history.Node(1)))
            .TIMES(1);
        REQUIRE_CALL(visitor, visit(history.Node(2)))
            .TIMES(1);
        history.WalkHistory(visitor);
    }
}
