  ...
  Density:
    ...
    SECTION("CalcCurrents") {
        std::vector<achilles::FourVector> momentum = {
            ...
            {11.179382065495107_GeV, 0.11140855999009017_GeV, 0.1334001474175966_GeV,
             0.0263039872165316_GeV},
            {3.195267141839163_GeV, -0.19106532624117684_GeV, 0.036750024067231254_GeV,
             3.189337797185557_GeV},
            {0.8015109318750572_GeV, 0.07305947032271103_GeV, -0.13285393143782712_GeV,
             0.7870399739612345_GeV},
            {0.16089135610832217_GeV, 0.006597295928375643_GeV, -0.03729624004700072_GeV,
             0.15636973695432532_GeV}};
        MockEvent e;
    ...
    SECTION("Properly fill event") {
        ...
        REQUIRE_CALL(*nucleus, Nucleons()).TIMES(3).LR_RETURN((nucleons));
